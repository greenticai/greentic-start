...
Whenever implementing a change, feature, refactor, or bugfix (i.e. PR-style work), follow this workflow:
...
- **Greentic reuse-first policy:**
  - Before adding new core types, interfaces, or cross-cutting functionality, CHECK whether they already exist in other Greentic repos:
    - `greentic-interfaces`
    - `greentic-types`
    - `greentic-secrets`
    - `greentic-oauth`
